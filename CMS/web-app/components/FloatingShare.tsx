...
export default function FloatingShare({ shareUrl = '', shareTitle = 'DotToDotFreePrintables' }: FloatingShareProps) {
  ...
  const handleCopy = async () => {
    const didCopy = await copyPageUrl(currentUrl());
    if (!didCopy) return;
    setCopied(true);
  ...
  return (
    <>
    <div className="floating-share" aria-label={t('shareMe')}>
    ...
    {!hideBookAd && <Link className="floating-book-ad" href={`/${locale}/premium/`} aria-label={tp('ad.viewPackAria')}>
      <Image
