...
- Name: mobile-and-links.spec.ts >> Home page — content >> FAQ section is present with questions
- Location: tests\mobile-and-links.spec.ts:61:7
...
Locator: getByRole('heading', { name: /frequently asked questions/i })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /frequently asked questions/i })
