...
- Name: mobile-and-links.spec.ts >> T-Rex 61-dot puzzle page — content >> meta chips show age, dots, and free label
- Location: tests\mobile-and-links.spec.ts:255:7
...
Locator: locator('.meta-chips').getByText(/100% free/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.meta-chips').getByText(/100% free/i)
