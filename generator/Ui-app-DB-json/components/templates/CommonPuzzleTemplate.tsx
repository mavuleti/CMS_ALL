...
export default async function CommonPuzzleTemplate({ params }: PuzzleRouteProps) {
  ...
  return <>
    ...
    <main>
      ...
      <ColoringGuide schemes={puzzle.dotGuide?.colorSchemes} heading={tPage?.has('colorH2') ? tPage('colorH2') : puzzle.name} />
